    ...
    <div class="floors">
      <div class="sk">
        <div class="sk_inner w1200">
          <div class="sk_hd">
            <a href="javascript:;">
              <img src="/static/image/s_img1.jpg">
            </a>
          </div>
          <div class="sk_bd">
            <div class="layui-carousel" id="test1">
              <div carousel-item>
                <div class="item-box">
                  <div class="item">
                    <a href="javascript:;"><img src="/static/image/s_img2.jpg"></a>
                  ...
                  <div class="item">
                    <a href="javascript:;"><img src="/static/image/s_img3.jpg"></a>
                    <div class="title">宝宝五彩袜棉质舒服</div>
                    <div class="price">
                      <span>￥49.00</span>
                      <del>￥99.00</del>
                  ...
                  <div class="item">
                    <a href="javascript:;"><img src="/static/image/s_img4.jpg"></a>
                    <div class="title">宝宝五彩袜棉质舒服</div>
                    <div class="price">
                      <span>￥49.00</span>
                      <del>￥99.00</del>
                  ...
                  <div class="item">
                    <a href="javascript:;"><img src="/static/image/s_img5.jpg"></a>
                    <div class="title">宝宝五彩袜棉质舒服</div>
                    <div class="price">
                      <span>￥49.00</span>
                      <del>￥99.00</del>
      ...
      <div class="tlinks">Collect from <a href="http://www.cssmoban.com/" >网页模板</a></div>
       <div class="hot-con1 w1200 layui-clear">
          <div class="item">
            <h4>热销推荐</h4>
            <div class="big-img">
              <a href="javascript:;"><img src="/static/image/hot1.png"></a>
            </div>
            <div class="small-img">
              <a href="javascript:;"><img src="/static/image/hot2.png" alt=""></a>
            </div>
          </div>
          <div class="item">
            <div class="top-img">
              <a href="javascript:;"><img src="/static/image/hot5.jpg"></a>
            </div>
            <div class="bottom-img">
              <a href="javascript:;"><img src="/static/image/hot6.jpg"></a>
              <a class="baby-cream" href="javascript:;"><img src="/static/image/hot7.jpg"></a>
            </div>
          </div>
          <div class="item item1 margin0 padding0">
            <a href="javascript:;"><img src="/static/image/hot8.jpg"></a>
            <a href="javascript:;"><img class="btm-img" src="/static/image/hot9.jpg"></a>
          </div>
      </div>
    </div>
    ...
    <div class="product-cont w1200" id="product-cont">
      <div class="product-item product-item1 layui-clear">
        <div class="left-title">
          <h4><i>1F</i></h4>
          <img src="/static/image/icon_gou.png">
          <h5>宝宝服饰</h5>
        </div>
        <div class="right-cont">
          <a href="javascript:;" class="top-img"><img src="/static/image/img12.jpg" alt=""></a>
          <div class="img-box">
            <a href="javascript:;"><img src="/static/image/s_img7.jpg"></a>
            <a href="javascript:;"><img src="/static/image/s_img8.jpg"></a>
            <a href="javascript:;"><img src="/static/image/s_img9.jpg"></a>
            <a href="javascript:;"><img src="/static/image/s_img10.jpg"></a>
            <a href="javascript:;"><img src="/static/image/s_img11.jpg"></a>
          </div>
        </div>
      </div>
    ...
    <div class="product-list-box" id="product-list-box">
      <div class="product-list-cont w1200">
        ...
        <div class="product-item-box layui-clear">
          <div class="list-item">
            <a href="javascript:;"><img src="/static/image/more1.jpg"></a>
