    ...
    <div class="cart w1200">
      ...
      <div class="OrderList">
        <div class="order-content" id="list-cont">
          <ul class="item-content layui-clear">
            ...
            <li class="th th-item">
              <div class="item-cont">
                <a href="javascript:;"><img src="static/image/paging_img1.jpg" alt=""></a>
                <div class="text">
          ...
          <ul class="item-content layui-clear">
            ...
            <li class="th th-item">
              <div class="item-cont">
                <a href="javascript:;"><img src="static/image/paging_img2.jpg" alt=""></a>
                <div class="text">
                  <div class="title">宝宝T恤棉质小衫</div>
                  <p><span>粉色</span>  <span>130</span>cm</p>
                </div>
          ...
          <ul class="item-content layui-clear">
            ...
            <li class="th th-item">
              <div class="item-cont">
                <a href="javascript:;"><img src="static/image/paging_img3.jpg" alt=""></a>
                <div class="text">
                  <div class="title">宝宝T恤棉质小衫</div>
                  <p><span>粉色</span>  <span>130</span>cm</p>
                </div>
      ...
      <div class="FloatBarHolder layui-clear">
        ...
        <div class="th Settlement">
          <button class="layui-btn"><a href="/front/order.jsp">结算</a></button>
        </div>
        <div class="th total">
