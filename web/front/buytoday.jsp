        ...
        <div class="inner-cont0">
          <div class="inner-cont1 w1200">
            <div class="inner-cont2">
              <a href="/front/commodity.jsp">所有商品</a>
              <a href="/front/buytoday.jsp" class="active">今日团购</a>
        ...
        <div class="product-list w1200">  
          ...
          <div class="list-cont" cont = 'tuangou'>
            <div class="item-box layui-clear">
              <div class="item">
                <img src="static/image/tuan_img1.jpg" alt="">
                <div class="text-box">
              ...
              <div class="item">
                <img src="static/image/tuan_img2.jpg" alt="">
                <div class="text-box">
                  <p class="title">宝宝专用硅胶环保饭碗四套+调羹+筷子自助学吃饭套装</p>
                  <p class="plic">
                    <span class="ciur-pic">￥100.00</span>
              ...
              <div class="item">
                <img src="static/image/tuan_img3.jpg" alt="">
                <div class="text-box">
                  <p class="title">宝宝专用硅胶环保饭碗四套+调羹+筷子自助学吃饭套装</p>
                  <p class="plic">
                    <span class="ciur-pic">￥100.00</span>
              ...
              <div class="item">
                <img src="static/image/tuan_img4.jpg" alt="">
                <div class="text-box">
                  <p class="title">宝宝专用硅胶环保饭碗四套+调羹+筷子自助学吃饭套装</p>
                  <p class="plic">
                    <span class="ciur-pic">￥100.00</span>
      ...
      <div class="footer-wrap">
        <div class="footer w1200">
          ...
          <div class="list-box layui-clear" id="footerList">
            <div class="item">
              <img src="static/image/tuan_img5.jpg" alt="">
              <div class="text">
            ...
            <div class="item">
              <img src="static/image/tuan_img6.jpg" alt="">
              <div class="text">
                <div class="right-title-number">1</div>
                <div class="commod">
                  <p>宝宝打底衣棉麻透气不起球白色多色可选</p>
            ...
            <div class="item">
              <img src="static/image/tuan_img7.jpg" alt="">
              <div class="text">
                <div class="right-title-number">1</div>
                <div class="commod">
                  <p>宝宝打底衣棉麻透气不起球白色多色可选</p>
